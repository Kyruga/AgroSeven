<?php
    $titulo = "Arquivos Propriedade - Agroseven";
    ...
    <section class="s-funcionarios">
        <div class="box-geral">
            ...
            <div class="lado-dir">
                ...
                <div class="conteudo-anexos">
                    <div class="tipo-anexo">
                        <h1>Tipo</h1>
                        <img src="<?php echo BASEURL ?>assets/img/seta-baixo-cinza.svg" alt="">
                    </div>
                    <div class="pesquisar-add">
                        <button class="btn-pesquisar">
                            <img src="<?php echo BASEURL ?>assets/img/icone-pesquisar.svg" alt=""> buscar
                        </button>
                        <a href="novo-arquivo.php" class="btn-add-funcionario">
                            <span>+</span> adicionar
                        </a>
                    ...
                    <div class="todos-anexos">
                        <div class="box-anexo">
                            <a href="#">
                            <img src="<?php echo BASEURL ?>assets/img/icone-nav-anexo.svg" class="icone-anexo" alt="">
                            <div class="texto">
                                <h1>CURICULLUM.PDF</h1>
                                <span>FÁBIO RABIM</span>
                                <span>16/02/2019</span>
                            </div>
                            <img src="<?php echo BASEURL ?>assets/img/seta-baixo-cinza-02.png" class="seta-baixo" alt="">
                        </a>
                        </div>
                        <div class="box-anexo">
                            <a href="#">
