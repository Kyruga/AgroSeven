        ...
        <div class="box-atualizacao">
            ...
            <div class="conteudo-at">
                ...
                <div class="lado-dir">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo BASEURL ?>areas/administrativo/views/anosafra.php">Ajustar Ano Safra</a>
                        </li>
                        <li>
                            <a href="<?php echo BASEURL ?>areas/administrativo/views/gleba.php">Cadastro de Gleba</a>
                        </li>
                        <li>
