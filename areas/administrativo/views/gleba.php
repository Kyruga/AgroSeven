                                    ...
                                    <form action="javascript:void(0);" method="post" id="formNovaGleba">
                                        ...
                                        <div class="form-group">
                                            <div class="form-left">
                                                ...
                                                <input name="numeroplantas" type="text">
                                            </div>                                
                                        </div>
                                        <div class="form-group">
                                            <div class="form-left">
                                        ...
                                        <div class="form-group">
                                            <div class="form-left">
                                                ...
                                                <input name="sacahectare" type="text">
                                            </div>                                
                                        </div>
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <div class="form-left">
                                                        <label for="">Stamd</label>
                                                        <input name="stamd" type="text">
                                                    </div>                                
                                                </div>
                                                <div class="form-group">
                                                    <div class="form-left">
                                                        <label for="">L PI</label>
                                                        <input name="lpi" type="text">
                                                    </div>                                
                                                </div>
                                                <div class="form-group">
                                                    <div class="form-left">
